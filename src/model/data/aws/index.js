 ...
 * @param {boolean} expand compact or full fragments
...
async function listFragments(ownerId, expand = false) {
  ...
  try {
    ...
    logger.warn({ err, params }, 'error reading fragments from DynamoDB');
    throw err;
  }
}
...
async function deleteFragment(ownerId, id) {
  ...
  // Set params for the deleteCommand to send to DynamoDB
